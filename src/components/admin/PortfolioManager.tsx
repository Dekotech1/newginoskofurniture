        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-stone-900 border border-stone-800 rounded-2xl max-w-3xl w-full p-6 space-y-5 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <label className="block text-xs font-semibold text-stone-400 mb-1">Location</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-stone-400 mb-1">Completion Year</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-stone-400 mb-1">Footprint / Size</label>
                <input
                  type="text"
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-stone-400 mb-1">Lead Architect / Firm</label>
                <input
                  type="text"
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-stone-400 mb-1">Overview Description</label>
                <textarea
                  rows={2}
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-stone-400 mb-1">Detailed Technical Specifications</label>
                <textarea
                  rows={4}
